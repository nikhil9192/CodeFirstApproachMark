...
using CodeFirstApproachMark.Data;
using CodeFirstApproachMark.Models;

namespace CodeFirstApproachMark.Controllers
{
    public class SubjectsController : ApiController
    {
        private CodeFirstApproachMarkContext db = new CodeFirstApproachMarkContext();
